...
public class XMLPage
{
	...
	public void load(File file)
	{
		try
		{
			...
			XMLStreamReader xml = new XMLStreamReaderImpl(in, new PropertyManager(PropertyManager.CONTEXT_READER));
	...
	public void save(File file)
	{
		try
		{
			...
			XMLStreamWriter xml = new XMLStreamWriterImpl(out, new PropertyManager(PropertyManager.CONTEXT_WRITER));
